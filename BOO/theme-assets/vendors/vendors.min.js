...
!function() {
    var e, t, o, n = {
        ...
        x: 0,
        y: 0
    }, c = !1, u = document.documentElement, d = [], s = /^Mac/.test(navigator.platform), f = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    function w() {
        if (!c && document.body) {
            ...
            var n = document.body
              ...
              , s = n.scrollHeight;
            if (u = document.compatMode.indexOf("CSS") >= 0 ? l : n,
            e = n,
            ...
            r.fixedBackground || a || (n.style.backgroundAttachment = "scroll",
    ...
    function y(e, t, o) {
        ...
        1 != r.accelerationMax) {
            ...
            if (i < r.accelerationDelta) {
                var c = (1 + 50 / i) / 2;
                c > 1 && (c = Math.min(c, r.accelerationMax),
                t *= c,
                o *= c)
            }
            v = Date.now()
        ...
        !p) {
            var u = e === document.body
              , d = function(n) {
                ...
                u ? window.scrollBy(i, l) : (i && (e.scrollLeft += i),
                l && (e.scrollTop += l)),
                t || o || (h = []),
    ...
    function b(t) {
        ...
        if (t.defaultPrevented || t.ctrlKey)
            return !0;
        if (A(e, "embed") || A(o, "embed") && /\.pdf/i.test(o.src) || A(e, "object") || o.shadowRoot)
            return !0;
        var n = -t.wheelDeltaX || t.deltaX || 0
          , a = -t.wheelDeltaY || t.deltaY || 0;
        s && (t.wheelDeltaX && B(t.wheelDeltaX, 120) && (n = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120),
        ...
        return l ? !!function(e) {
            ...
            !N(120) && !N(100)
        }(a) || (Math.abs(n) > 1.2 && (n *= r.stepSize / 120),
        Math.abs(a) > 1.2 && (a *= r.stepSize / 120),
        y(l, n, a),
        t.preventDefault(),
        void E()) : !i || !W || (Object.defineProperty(t, "target", {
    ...
    function g(t) {
        ...
        if (t.defaultPrevented || /^(textarea|select|embed|object)$/i.test(o.nodeName) || A(o, "input") && !a.test(o.type) || A(e, "video") || function(e) {
            ...
            return !0;
        if ((A(o, "button") || A(o, "input") && a.test(o.type)) && t.keyCode === f.spacebar)
            return !0;
        if (A(o, "input") && "radio" == o.type && m[t.keyCode])
            return !0;
        var l = 0
          , c = 0
          , u = H(e);
        if (!u)
            return !i || !W || parent.keydown(t);
    ...
    function q(e) {
        var t, o;
        return (e *= r.pulseScale) < 1 ? t = e - (1 - Math.exp(-e)) : (e -= 1,
        t = (o = Math.exp(-1)) + (1 - Math.exp(-e)) * (1 - o)),
        t * r.pulseNormalize
    }
    function V(e) {
        return e >= 1 ? 1 : e <= 0 ? 0 : (1 == r.pulseNormalize && (r.pulseNormalize /= q(1)),
        q(e))
    }
    var F, I = window.navigator.userAgent, _ = /Edge/.test(I), W = /chrome/i.test(I) && !_, $ = /safari/i.test(I) && !_, U = /mobile/i.test(I), G = /Windows NT 6.1/i.test(I) && /rv:11/i.test(I), J = $ && (/Version\/8/i.test(I) || /Version\/9/i.test(I)), Q = (W || $ || G) && !U;
    function Z(e) {
        for (var t in e)
...
!function(t) {
    ...
    t.widget.bridge = function(e, i) {
        ...
        t.fn[e] = function(o) {
            var r = "string" == typeof o
              ...
              , h = this;
            return o = !r && a.length ? t.widget.extend.apply(null, [o].concat(a)) : o,
            r ? this.each(function() {
                var s, i = t.data(this, n);
                return "instance" === o ? (h = i,
                !1) : i ? t.isFunction(i[o]) && "_" !== o.charAt(0) ? (s = i[o].apply(i, a),
                s !== i && void 0 !== s ? (h = s && s.jquery ? h.pushStack(s.get()) : s,
    ...
    t.each({
        ...
        t.Widget.prototype["_" + e] = function(i, n, o) {
            ...
            r && t.effects && t.effects.effect[a] ? i[e](n) : a !== e && i[a] ? i[a](n.duration, n.easing, o) : i.queue(function(s) {
                t(this)[e](),
                o && o.call(i[0]),
                s()
            })
    ...
    t.widget("aerolab.midnight", {
        ...
        _getContainerHeight: function() {
            ...
            return e.length ? e.each(function() {
                ...
                o.length ? (o.css("bottom", "auto").css("overflow", "auto"),
                i = o.outerHeight(),
                o.css("bottom", "0")) : (e.css("bottom", "auto"),
                i = e.outerHeight(),
                e.css("bottom", "0")),
                s = i > s ? i : s
        ...
        _recalculateHeaders: function() {
            ...
            for (var a in this._headers)
                this._headers.hasOwnProperty(a) && (this._headers[a].from = "",
                this._headers[a].progress = 0);
            for (var h = 0; h < this._sections.length; h++)
                s >= this._sections[h].start && e <= this._sections[h].end && (this._headers[this._sections[h].className].visible = !0,
        ...
        _updateHeaders: function() {
            if ("undefined" != typeof this._headers[this.options.defaultClass]) {
                ...
                for (var s in this._headers)
                    this._headers.hasOwnProperty(s) && "" !== !this._headers[s].from && (t += this._headers[s].progress,
                    e = s);
                t < 1 && ("" === this._headers[this.options.defaultClass].from ? (this._headers[this.options.defaultClass].from = "top" === this._headers[e].from ? "bottom" : "top",
                ...
                for (var i in this._headers)
                    if (this._headers.hasOwnProperty(i) && "" !== !this._headers[i].from) {
                        ...
                        n >= 100 && (n = 110),
                        n <= -100 && (n = -110),
                        "top" === this._headers[i].from ? this._transformMode !== !1 ? (this._headers[i].element[0].style[this._transformMode] = "translateY(-" + n + "%) translateZ(0)",
